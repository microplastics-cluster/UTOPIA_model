...
def create_inputsTable(compartments, modelBoxes, inputs_path):
    ...
    cond_frag = (
        ...
        & (dataFrame_inputs["Compartment"] == "Surface Water")
    ...
    cond_frag2 = (
        (
            (dataFrame_inputs["Compartment"] == "Flowing Water")
            | (dataFrame_inputs["Compartment"] == "Stagnant Water")
