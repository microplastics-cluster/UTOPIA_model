...
def generate_objects(
    ...
    compartments = instantiate_compartments(os.path.join(inputs_path, comp_impFile_name))
    ...
    set_interactions(
        compartments, connexions_path_file=os.path.join(inputs_path, comp_interactFile_name)
    )
