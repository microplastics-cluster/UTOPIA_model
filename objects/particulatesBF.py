...
class ParticulatesBF(Particulates):
    ...
    # constructor
    def __init__(self, parentMP, BF_density_kg_m3=1388, BF_thickness_um=5):
        # default values
        ...
        self.BF_thickness_um = BF_thickness_um
        ...
        if parentMP.PdimensionY_um == 0:
            ...
            self.PdimensionY_um = parentMP.PdimensionY_um + BF_thickness_um * 2

        if parentMP.PdimensionZ_um == 0:
            self.PdimensionZ_um = 0
        else:
            self.PdimensionZ_um = parentMP.PdimensionZ_um + BF_thickness_um * 2

        if parentMP.PdimensionX_um == 0:
            self.PdimensionX_um = 0
        else:
            self.PdimensionX_um = parentMP.PdimensionX_um + BF_thickness_um * 2
